...
export const czechGivenNamesMale = () => {
  const givenNames = [
    'Bedrich', 'Cerny', 'Damek', 'Karel', 'Kliment', 'Ladislav', 'Libor', 'Ludomir', 'Oldrich', 'Radek', 'Radoslav', 'Rehor', 'Strom', 'Vasil', 'Vavrin', 'Vavrinec', 'Veleslav', 'Venec', 'Vila', 'Vladislav', 'Vojtech', 'Zdenek', 'Zitomer'
  ];
  
  return getRandomName(givenNames);
};

export const danishGivenNamesMale = () => {
  const givenNames = [
    'Bartram', 'Diederik', 'Gardiner', 'Hobart', 'Ib', 'Nils', 'Soren'
  ];
  
  return getRandomName(givenNames);
};

export const dutchGivenNamesMale = () => {
  const givenNames = [
    'Hodding', 'Kyler', 'Maarten', 'Rembrandt', 'Rodolf', 'Roosevelt', 'Schuyler', 'Sklaer', 'Van', 'Vandyke', 'Wagner', 'Zeeman'
  ];
  
  return getRandomName(givenNames);
};

export const egyptianGivenNamesMale = () => {
  const givenNames = [
    'Imhotep', 'Paki', 'Rahotep', 'Zahur'
  ];
  
  return getRandomName(givenNames);
};

export const englishGivenNamesMale = () => {
  const givenNames = [
